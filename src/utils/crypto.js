...
const { byteArrayToWordArray, wordArrayToByteArray, generateChecksum } = require('./binary');
...
module.exports = {
    createSecp256K1KeyPair, getAccountCredentials, getAccountId, fromHexString,
    toHexString, to32bits, from32bits, tokenIdentifier, decodeTokenId, mockPrincipal
};
