...
export const idlFacroty =({ IDL }) => {
  ...
  return IDL.Service({
    ...
    'removeStatsCollectionList' : IDL.Func(
        [IDL.Principal, IDL.Vec(TokenIdentifier)],
        [],
        [],
      ),
    ...
    'setICPSettlements' : IDL.Func(
        [IDL.Nat, User, IDL.Nat64, IDL.Nat64, TokenSpec],
        [],
        [],
      ),
