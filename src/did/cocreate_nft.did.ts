...
export const idlFactory = ({ IDL }) => {
  ...
  const CoCreateMetadata = IDL.Record({
    'logo' : IDL.Opt(IDL.Text),
    'name' : IDL.Opt(IDL.Text),
  ...
  return IDL.Service({
    ...
    'batch_mint' : IDL.Func([MintRequest, IDL.Nat32], [IDL.Vec(IDL.Nat32)], []),
    'batch_transfer' : IDL.Func([TransferRequestV1], [IDL.Vec(IDL.Nat)], []),
    ...
    'operator_of' : IDL.Func([IDL.Nat], [IDL.Opt(IDL.Text)], ['query']),
    'owner_of' : IDL.Func([IDL.Nat], [IDL.Opt(IDL.Text)], ['query']),
    ...
    'update_cocreate_token_status' : IDL.Func([IDL.Nat], [], []),
  });
  };
      // @ts-ignore
